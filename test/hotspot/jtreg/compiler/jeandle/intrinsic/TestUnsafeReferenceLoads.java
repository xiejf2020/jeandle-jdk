...
public class TestUnsafeReferenceLoads {
    ...
    private static void checkEnabledIR(String dumpPath, boolean g1) throws Exception {
        ...
        // Jeandle performance currently disables compressed oops; reference
        // JavaOps therefore operate on JavaHeapAddrSpace (addrspace(1)).
